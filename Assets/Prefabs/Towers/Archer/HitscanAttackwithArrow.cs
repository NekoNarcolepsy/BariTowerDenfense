...
namespace TowerDefense.Towers.Projectiles
{
	...
	public class HitscanAttackwithArrow : MonoBehaviour
	{
		/// <summary>
		...
		protected void DealDamage()
		{
			...
			Instantiate(Arrow,transform.position,new Quaternion(0,0,0,0)).GetComponent<Arrow>().SetEnemy(m_Enemy.gameObject);
